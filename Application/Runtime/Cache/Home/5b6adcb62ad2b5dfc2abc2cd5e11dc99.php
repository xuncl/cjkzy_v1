...
<html lang="zh-CN">
	...
	<body class="login-layout">
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='/cjkzy_v1/Public/qwadmin/js/jquery.js'>"+"<"+"/script>");
		</script>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='/cjkzy_v1/Public/qwadmin/js/jquery1x.js'>"+"<"+"/script>");
</script>
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='/cjkzy_v1/Public/qwadmin/js/jquery.mobile.custom.js'>"+"<"+"/script>");
		</script>
